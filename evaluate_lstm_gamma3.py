"""
Evaluation Script for LSTM Baseline (Focal Loss gamma=3.0)
Focal Loss gamma=3.0で訓練したLSTMベースラインモデルの評価
"""
...
def evaluate_model_with_optimization(
    ...
    print("\n" + "="*80)
    print("📊 Evaluation Results (Focal Loss gamma=3.0, optimized thresholds)")
    print("="*80)
...
def main():
    print("="*80)
    print("🔍 LSTM Baseline Evaluation (Focal Loss gamma=3.0)")
    print("="*80)
    ...
    # モデルロード
    print("\n" + "="*80)
    print("📂 Loading model (gamma=3.0)...")
    print("="*80)
    
    model_path = MODEL_ROOT / "lstm_baseline_gamma3" / "best_model"
    ...
    print("\n" + "="*80)
    print("✅ LSTM Baseline (gamma=3.0) Evaluation Complete!")
    print("="*80)
